	...
	<div class="row">
		<div class="col-md-12" style="margin-top: 50px;">
			<div class="box box-primary">
				...
				<form role="form" method="post" action="index.php?controller=monhoc&action=insertmonhoc"  enctype="multipart/form-data">
					<div class="box-body">
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputEmail1">Mã Môn Học</label><span class="error"></span>
								<input type="text" name="code" class="form-control" id="exampleInputEmail1" placeholder="Mã bài giảng" required="" autofocus>
								<input type="text" name="hp" value="<?php echo $_GET["hp"] ?>" style="display: none;">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputPassword1">Tên Môn Học</label>
								<input type="text" name="name" class="form-control" id="exampleInputPassword1" placeholder="Tên bài giảng" required="">
							</div>
						</div>
					</div>
