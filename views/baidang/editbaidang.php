	...
	<div class="row">
		<div class="col-md-12" style="margin-top: 50px;">
			<div class="box box-primary" style="background-color: #e6e6e6;">
				...
				<div class="col-md-10">
					<form role="form" method="post" action="index.php?controller=baidang&action=updatebaidang"  enctype="multipart/form-data">
						<div class="box box-primary">
					        <div class="box-header">
					          <div class="box-tools pull-right">
					          	<span class="input">
					          		<input type="text" name="id" value="<?php echo $posts->id; ?>" style="display: none;">
									<input type="text" name="date" value="<?php echo $posts->date; ?>">
								</span>
					          </div>
					          <br>
					          ...
					          <h3 class="box-title">
					          	<span class="input">
									<input type="text" name="title" style="min-width: 30em" value="<?php echo $posts->title; ?>" placeholder="Tiêu đề . . . ">
								</span>
					          </h3>
					        </div>
					        <div class="box-body">
					          <div class="form-group">
									...
									<div class="box box-info">
										<div class="box-body pad">
											<textarea class="textarea" name="content" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $posts->content; ?></textarea>
										</div>
									</div>
								</div>
					        </div>
